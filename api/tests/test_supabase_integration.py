...
class TestSupabaseConnection:
    ...
    def test_database_connectivity(self):
        ...
        try:
            ...
            result = supabase_service.client.table("user_profiles").select("id").limit(1).execute()
    ...
    def test_rls_policies_exist(self):
        ...
        try:
            ...
            result = supabase_service.client.table("user_profiles").select("*").execute()
            ...
            assert any(keyword in error_msg for keyword in ["policy", "permission", "access", "rls"])
...
class TestSupabaseOperations:
    ...
    def test_user_creation_structure(self, test_user_id):
        ...
        assert user_metadata["user_type"] in ["property_manager", "contractor", "tenant"]
...
class TestSupabaseErrorHandling:
    ...
    def test_invalid_column_access(self):
        ...
        try:
            result = supabase_service.client.table("user_profiles").select("non_existent_column").execute()
...
class TestSupabaseConfiguration:
    ...
    def test_environment_variables(self):
        ...
        for var in required_vars:
            ...
            if var == "SUPABASE_URL":
                ...
                assert "supabase.co" in value, "SUPABASE_URL should be a Supabase domain"
    ...
    def test_supabase_project_id(self):
        ...
        assert expected_project_id in url, f"Connected to wrong Supabase project. Expected {expected_project_id}"
    ...
    def test_api_key_format(self):
        ...
        for part in parts:
            assert all(c.isalnum() or c in "-_" for c in part), "Invalid JWT token format"
...
class TestSupabaseAuth:
    ...
    def test_auth_error_handling(self):
        ...
        try:
            ...
            error_msg = str(e).lower()
            assert any(keyword in error_msg for keyword in ["invalid", "auth", "credentials", "login"])
...
class TestDatabaseSchema:
    ...
    def test_required_tables_exist(self):
        ...
        assert len(existing_tables) >= 2, f"Missing required tables. Found: {existing_tables}"
