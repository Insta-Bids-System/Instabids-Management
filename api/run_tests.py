...
def run_security_tests():
    ...
    success, stdout, stderr = run_command(
        "python -m pytest tests/ -v --tb=short -m security",
...
def main():
    ...
    if not check_environment():
        print("[FAIL] Environment check failed. Please fix issues before running tests.")
        sys.exit(1)
    ...
    # 4. Performance Tests
    results["Performance Tests"] = (run_performance_tests(), "Performance and load tests")
    
    # 5. Coverage Report
    results["Coverage Report"] = (run_coverage_report(), "Code coverage analysis")
    
    # 6. Comprehensive Test
    results["Comprehensive System Test"] = (run_comprehensive_test(), "Full system verification")
